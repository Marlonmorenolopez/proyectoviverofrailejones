...
foreach ($archivo in $archivos) {
    ...
    $contenido = $contenido -replace "Pépinià¨re", "Pépinière"
    $contenido = $contenido -replace "Mise à  jour", "Mise à jour"
    $contenido = $contenido -replace "mise à  jour", "mise à jour"
    $contenido = $contenido -replace "Biodiversità¤t", "Biodiversität"
    $contenido = $contenido -replace "auswà¤hlen", "auswählen"
    $contenido = $contenido -replace "à¤", "ä"
    $contenido = $contenido -replace "à¨", "è"
